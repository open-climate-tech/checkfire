  ...
  useEffect(() => {
    ...
    if (index === scrollToIndex && scrollingTo === null) {
      ...
      const top = Math.round(
        scrollTop + container.getBoundingClientRect().top - scrollTopThreshold
      );
        ...
        <div className="cc7e-fire--video-container">
          ...
          >
            {shouldLoadVideo === true && (
              <source src={croppedUrl} type="video/mp4" />
            )}
        ...
        <div className="c7e-fire--caption">
          <p className="c7e-fire--location">
            <span className="c7e-dateline">
              ...
              <span className="c7e-fire--date-time">
                {' '}
                · <DateTimeDistance date={date} /> · <DateTime date={date} />
              </span>
            </span>
            <IconButton
              className="c7e-fire--full-image"
              icon="c7e-icon--full-image"
          ...
          <p className="c7e-fire--attribution">
            ...
            ›{' '}
            <a href={camerakUrl} target="_blank" rel="noopener noreferrer">
              {cameraName}
            </a>
            {cameraDir && (
              <>
