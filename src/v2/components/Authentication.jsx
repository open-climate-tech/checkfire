  ...
  const handleCredentials = useCallback(
    (event) => {
      ...
      setTimeout(
        ...
        250
      ); // Give user time to perceive submission and error state changes.
    },
      ...
      <Overlay onClick={onCancel}>
        <div className="c7e-dialog">
          ...
          <div className="c7e-authentication--oauth">
            <Button
              className="c7e-dialog--button--fill"
              icon="c7e-logomark--google-g"
              label="Sign in with Google"
              onClick={handleGoogle}
            />
            <Button
              className="c7e-dialog--button--fill"
              icon="c7e-logomark--facebook-f"
          ...
          <div className="c7e-authentication--tabs">
            <div
              className={`c7e-authentication--tab${
                mode === 'authentication' ? ' c7e-selected' : ''
              }`}
              onClick={() => handleMode('authentication')}
            >
              Sign in
            </div>
            <div
              className={`c7e-authentication--tab${
                mode === 'registration' ? ' c7e-selected' : ''
              }`}
          ...
          {mode === 'authentication' && (
            <form
              className="c7e-authentication--credentials"
