...
import googleSigninImgImport from '../src/btn_google_signin_dark_normal_web.png';
const googleSigninImg = typeof googleSigninImgImport === 'string' ? googleSigninImgImport : googleSigninImgImport.src;
import googleSigninImgFocusImport from '../src/btn_google_signin_dark_focus_web.png';
...
export default function Login(props) {
  ...
  const fwdPathQuery = router.query.fwdPath;
  const fwdPath =
    typeof fwdPathQuery === 'string'
      ? fwdPathQuery
      : Array.isArray(fwdPathQuery)
      ? fwdPathQuery[0] || '/'
      : '/';
